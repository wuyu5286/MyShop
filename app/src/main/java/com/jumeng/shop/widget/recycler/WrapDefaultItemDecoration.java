 ...
 * ============================================================
 */
public class WrapDefaultItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private int mLayoutManagerType = WrapRecyclerView.LAYOUT_MANAGER_TYPE_LINEAR; // WrapRecyclerView.LAYOUT_MANAGER_TYPE_*
    ...
    public WrapDefaultItemDecoration(RecyclerView recyclerView, Drawable dividerVertical, Drawable dividerHorizontal, int dividerDrawableSizeVertical, int dividerDrawableSizeHorizontal) {
    ...
    private void init(RecyclerView mRecyclerView) {
        ...
        if (mLayoutManager.getClass().isAssignableFrom(LinearLayoutManager.class)) {
            mLayoutManagerType = WrapRecyclerView.LAYOUT_MANAGER_TYPE_LINEAR;
            ...
            mLayoutManagerType = WrapRecyclerView.LAYOUT_MANAGER_TYPE_GRID;
            ...
            mLayoutManagerType = WrapRecyclerView.LAYOUT_MANAGER_TYPE_STAGGERED_GRID;
    ...
    private void drawDividerDrawable(Canvas c, RecyclerView parent) {
        ...
        WrapRecyclerView curWrapRecyclerView = null;
        if (parent instanceof WrapRecyclerView) {
            curWrapRecyclerView = (WrapRecyclerView) parent;
            headersCount = curWrapRecyclerView.getHeaderViewsCount();
            footerCount = curWrapRecyclerView.getFooterViewsCount();
            itemViewCount = curWrapRecyclerView.getAdapter().getItemCount() - headersCount - footerCount;
        } else {
        ...
        for (int i = 0; i < parent.getChildCount(); i++) {
            ...
            if (mLayoutManagerType == WrapRecyclerView.LAYOUT_MANAGER_TYPE_LINEAR
            ...
            boolean isEmptyView = isEmptyView(curWrapRecyclerView, position, headersCount);
            ...
            switch (mLayoutManagerType) {
                case WrapRecyclerView.LAYOUT_MANAGER_TYPE_LINEAR:
                    // LinearLayoutManager
                    ...
                    break;
                case WrapRecyclerView.LAYOUT_MANAGER_TYPE_GRID:
                case WrapRecyclerView.LAYOUT_MANAGER_TYPE_STAGGERED_GRID:
                    ...
                    if (mLayoutManagerType == WrapRecyclerView.LAYOUT_MANAGER_TYPE_GRID && position == (itemViewCount + headersCount - 1)) {
                    ...
                    if (mOrientation == OrientationHelper.HORIZONTAL) {
                        ...
                        if (!isGridLayoutLastNum && !isGridItemLayoutLastColumn) {
                            ...
                            if (mLayoutManagerType == WrapRecyclerView.LAYOUT_MANAGER_TYPE_STAGGERED_GRID && !isGridItemLayoutLastRow) {
                        ...
                        if (isGridItemLayoutFirstRow) {
                        ...
                        } else if (mLayoutManagerType == WrapRecyclerView.LAYOUT_MANAGER_TYPE_GRID && isGridItemLayoutLastRow) {
                            ...
                            if (mLayoutManagerType == WrapRecyclerView.LAYOUT_MANAGER_TYPE_GRID && !isGridItemLayoutLastColumn) {
                        ...
                        if (!isGridItemLayoutLastColumn
                                && ((mLayoutManagerType == WrapRecyclerView.LAYOUT_MANAGER_TYPE_GRID && !isGridLayoutLastNum)
                                || mLayoutManagerType == WrapRecyclerView.LAYOUT_MANAGER_TYPE_STAGGERED_GRID)) {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (isHeadViewPos(headersCount, position)) {
            ...
            return ;
        } else if (isEmptyView(curWrapRecyclerView, position, headersCount)) {
            // emptyView
        ...
        // set itemView
        if (mLayoutManagerType == WrapRecyclerView.LAYOUT_MANAGER_TYPE_GRID || mLayoutManagerType == WrapRecyclerView.LAYOUT_MANAGER_TYPE_STAGGERED_GRID) {
    ...
    private void processGridOffsets(Rect outRect, int position, int headersCount, View view) {
        int curGridNum;
        if (mLayoutManagerType == WrapRecyclerView.LAYOUT_MANAGER_TYPE_GRID) {
    ...
    private boolean isEmptyView(WrapRecyclerView WrapRecyclerView, int position, int headersCount) {
        if (null != WrapRecyclerView && WrapRecyclerView.isKeepShowHeadOrFooter()
                && WrapRecyclerView.isShowEmptyView() && position == headersCount) {
            return true;
        }
    ...
    private boolean isGridItemLayoutLastRow(int position, int itemViewCount, int headersCount) {
        if (mLayoutManagerType == WrapRecyclerView.LAYOUT_MANAGER_TYPE_LINEAR) return false;
    ...
    private boolean isGridItemLayoutLastColumn(int position, int headersCount, View view) {
        ...
        } else if (mLayoutManagerType == WrapRecyclerView.LAYOUT_MANAGER_TYPE_STAGGERED_GRID) {
